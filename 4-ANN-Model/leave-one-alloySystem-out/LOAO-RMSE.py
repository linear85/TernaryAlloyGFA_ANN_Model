...
plt.xlabel("Ternary alloy system", fontsize=20)
plt.ylabel(r"$RMSE$", fontsize=20)
plt.legend(frameon=True, prop={'size':12})
plt.axvline(x=4.5,color='black')
plt.text(0, 0.8, "High-throughput", fontsize=20)
plt.text(11.0, 0.8, "Traditional", fontsize=20)
